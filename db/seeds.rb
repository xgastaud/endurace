...
race9 = Race.new(name:"Course Cycliste de Metz", sport:"Cyclisme", format:"50km", starts_at: DateTime.current, address:"Metz", year:"2018", description:"Le départ de la natation est donné sur la célèbre plage de sable fin de Deauville, avec ses parasols colorés. Attendez-vous à une température de l’eau variant entre 16 à 20 degrés ainsi qu’à des courants qui vous secouent un peu. A noter que l’épreuve de natation sera lancée à marée haute et qu’une sortie à l’Australienne est prévue, soit une boucle de 950m de nage à réaliser deux fois.
...
Mais attention, notre parcours n’a rien d’une balade de santé. La boucle de 42,5km (à réaliser 2 fois) est très technique et tout en relance. La première difficulté arrive très vite après 2km de parcours avec la fameuse côte de Saint-Laurent (15% /de dénivelé sur 1km). La descente vers Saint-Arnoult est ensuite très technique. A peine le temps de récupérer que c’est la longue côte de Reux qui se profile, puis celle de Benerville-sur-Mer avant la plongée finale et le retour vers Deauville par l’hippodrome de Clairefontaine.
", url:"https://triathlondeauville.com/", registration_url:"https://www.njuko.net/tid2018/select_competition", available_slots:1000, distance_swim:0, distance_bike:50, distance_run:0, vertical_ascent_bike:1500, vertical_ascent_run:0)
race9.save

race10 = Race.new(name:"Course Cycliste de Nancy", sport:"Cyclisme", format:"100km", starts_at: DateTime.current, address:"Nancy", year:"2018", description:"Le départ de la natation est donné sur la célèbre plage de sable fin de Deauville, avec ses parasols colorés. Attendez-vous à une température de l’eau variant entre 16 à 20 degrés ainsi qu’à des courants qui vous secouent un peu. A noter que l’épreuve de natation sera lancée à marée haute et qu’une sortie à l’Australienne est prévue, soit une boucle de 950m de nage à réaliser deux fois.
